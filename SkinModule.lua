local v0 = {
    Color3.new(1, 0.560784, 0.956863), 
    ColorSequence.new(Color3.new(1, 0.560784, 0.956863), Color3.new(1, 0.027451, 0.839216))
};
local v1 = {
    Color3.new(1, 0.027451, 0.839216), 
    ColorSequence.new(Color3.new(0.0588235, 0.0313725, 0.054902), Color3.new(1, 0.027451, 0.839216))
};
local v2 = {
    Color3.new(1, 0, 0.4), 
    ColorSequence.new(Color3.new(0.0588235, 0.0313725, 0.054902), Color3.new(1, 0.027451, 0.839216))
...
local v3 = {
    Color3.new(0.560784, 0.470588, 1), 
    ColorSequence.new(Color3.new(0.560784, 0.470588, 1), Color3.new(0.576471, 0.380392, 1))
};
local v4 = {
    Color3.new(0.113725, 0.113725, 0.113725), 
    ColorSequence.new(Color3.new(0.113725, 0.113725, 0.113725), Color3.new(0, 0, 0))
};
local v5 = {
    Color3.new(1, 0.333333, 1), 
    ColorSequence.new(Color3.new(1, 0.333333, 1), Color3.new(0.666667, 0.333333, 1))
};
local v6 = {
    Color3.new(0.164706, 0.333333, 0.0862745), 
    ColorSequence.new(Color3.new(1, 0.94902, 0.862745), Color3.new(0.196078, 0.333333, 0.0823529))
};
local v7 = {
    Color3.new(0, 0.47451, 0.709804), 
    ColorSequence.new(Color3.new(1, 0.94902, 0.862745), Color3.new(0, 0.47451, 0.713725))
};
local v8 = {
    Color3.new(0, 0.984314, 1), 
    ColorSequence.new(Color3.new(0, 1, 1), Color3.new(0, 1, 0.701961))
};
local v9 = {
    Color3.new(1, 0.329412, 0.741176), 
    ColorSequence.new({
...
local v12 = {
    Color3.new(0, 1, 1), 
    ColorSequence.new(Color3.new(0, 1, 1), Color3.new(0.666667, 1, 1))
};
local v13 = {
    Color3.new(0.415686, 0, 1), 
    ColorSequence.new(Color3.new(0.431373, 0.0235294, 1), Color3.new(0.54902, 0, 1))
};
local _ = {
    Color3.new(0, 0, 0), 
    ColorSequence.new(Color3.new(0, 0.101961, 0.101961), Color3.new(0.113725, 0.113725, 0.113725))
};
local v15 = {
    Color3.new(0, 1, 0.498039), 
    ColorSequence.new(Color3.new(0, 1, 0.498039), Color3.new(0, 0.729412, 0.352941))
};
local v16 = {
    Color3.new(0.282353, 0.792157, 0.945098), 
    ColorSequence.new({
...
local v18 = {
    Color3.new(1, 0.690196, 0.882353), 
    ColorSequence.new(Color3.new(1, 0.690196, 0.882353), Color3.new(1, 0.929412, 0.964706))
};
local v19 = {
    Color3.new(1, 0.666667, 0), 
    ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.new(0, 1, 0)), 
        ColorSequenceKeypoint.new(0.5, Color3.new(0.666667, 0.333333, 1)), 
        ColorSequenceKeypoint.new(1, Color3.new(1, 0.666667, 0))
    })
};
local v20 = {
    Color3.new(1, 0, 0), 
    ColorSequence.new(Color3.new(1, 0, 0), Color3.new(1, 1, 1))
};
local v21 = {
    Color3.new(1, 0, 0), 
    ColorSequence.new({
...
local v22 = {
    Color3.new(1, 0.666667, 0), 
    ColorSequence.new(Color3.new(1, 1, 0), Color3.new(0.109804, 0.317647, 1))
};
local v23 = {
    Color3.new(0.235294, 1, 0), 
    ColorSequence.new(Color3.new(1, 0, 0), Color3.new(0, 1, 0))
};
local v24 = {
    Color3.new(0.752941, 0.294118, 0.796078), 
    ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.new(0.501961, 0.760784, 0.862745)), 
        ColorSequenceKeypoint.new(0.5, Color3.new(0.823529, 0.839216, 0.870588)), 
        ColorSequenceKeypoint.new(1, Color3.new(0.776471, 0.458824, 0.584314))
    })
};
local v25 = {
    Color3.new(0.333333, 1, 0.498039), 
    ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.new(0.333333, 1, 0.498039)), 
...
local v26 = {
    ...
    ColorSequence.new({
        ...
        ColorSequenceKeypoint.new(0.5, Color3.new(1, 0.333333, 1)), 
        ColorSequenceKeypoint.new(1, Color3.new(0.333333, 0.666667, 1))
    })
};
local v27 = {
    Color3.new(0.666667, 0.666667, 1), 
    ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.new(0.666667, 0.666667, 1)), 
        ColorSequenceKeypoint.new(0.5, Color3.new(0.666667, 0.333333, 1)), 
        ColorSequenceKeypoint.new(1, Color3.new(0.333333, 0.333333, 1))
    })
};
local v28 = {
    Color3.new(1, 0.372549, 0.0588235), 
    ColorSequence.new(Color3.new(1, 0.333333, 0), Color3.new(0.8, 0.690196, 0.0666667))
};
local v29 = {
    Color3.new(0.45098, 0, 1), 
    ColorSequence.new(Color3.new(0.501961, 0, 1), Color3.new(1, 0, 0.298039))
};
local v30 = {
    Color3.new(0.831373, 1, 0), 
    ColorSequence.new(Color3.new(0.831373, 1, 0), Color3.new(0.945098, 0.839216, 0.231373))
};
local v31 = {
    Color3.new(0.643137, 0.952941, 1), 
    ColorSequence.new(Color3.new(0.752941, 0.976471, 1), Color3.new(0.196078, 0.945098, 0.882353))
};
local v32 = {
    ["[Revolver]"] = {
        Valentine = {
        ...
        Testing = {
            DisplayName = "N/A", 
            TextureID = script.Meshes.Testing, 
            Rarity = "Exclusive", 
            CFrame = CFrame.new(0, 0, 0), 
            BorderColor = {
                Color3.new(0.945098, 1, 0.882353), 
                ColorSequence.new(Color3.new(0.831373, 1, 0.756863), Color3.new(0.890196, 0.737255, 0.431373))
            }
        }, 
        Shadow = {
            TextureID = script.Meshes.Shadow.RevolverGhost, 
            Rarity = "Exclusive", 
            CFrame = CFrame.new(1.52587891E-5, 0, 0, 1, 0, 8.74227766E-8, 0, 1, 0, -8.74227766E-8, 0, 1), 
            BorderColor = v3
        }, 
        ["Battleworn Green"] = {
        ...
        ["Golden Age"] = {
            TextureID = script.Meshes.GoldenAge.Revolver, 
            Rarity = "Legendary", 
            CFrame = CFrame.new(0.0295257568, 0.0725820661, -9.46044922E-4, 1, -4.89858741E-16, -7.98081238E-23, 4.89858741E-16, 1, 3.2584137E-7, -7.98081238E-23, -3.2584137E-7, 1), 
            Crate = 999
        }, 
        ["Web-Hero II"] = {
            TextureID = script.Meshes.HERO.HeroWeb2, 
            Rarity = "Legendary", 
        ...
        ["Web-Hero III"] = {
            TextureID = script.Meshes.HERO.HeroWeb3, 
            Rarity = "Legendary", 
            CFrame = CFrame.new(-0.0891418457, -0.0215809345, -0.0041809082, -1.99520325E-23, -1.62920685E-7, 1, 2.44929371E-16, 1, 1.62920685E-7, -1, 2.44929371E-16, 1.99520294E-23), 
            BorderColor = v21, 
            Crate = 999
        ...
        Dragon = {
            TextureID = script.Meshes.Dragon.DragonRev, 
            Rarity = "Legendary", 
            CFrame = CFrame.new(0.0384216309, 0.0450432301, -6.71386719E-4, 1.87045402E-31, 4.21188801E-16, -0.99999994, 1.77635684E-15, 1, -4.21188827E-16, 1, 1.77635684E-15, -1.87045413E-31), 
            Crate = 999
        }, 
        Heaven = {
            TextureID = script.Meshes.Heaven.Revolver, 
            Rarity = "Legendary", 
        ...
        ["Thunder II"] = {
            TextureID = script.Meshes.Stars.RevolverII, 
            Rarity = "Legendary", 
        ...
        Void = {
            TextureID = script.Meshes.Void.rev, 
            Rarity = "Legendary", 
        ...
        Raygun = {
            TextureID = script.Meshes.Raygun.rev, 
            Rarity = "Legendary", 
    ...
    ["[DrumGun]"] = {
        ...
        Shadow = {
            TextureID = script.Meshes.Shadow.DrumgunGhost, 
            Rarity = "Exclusive", 
            CFrame = CFrame.new(1.14440918E-5, 0, 0, 1, 0, 8.74227766E-8, 0, 1, 0, -8.74227766E-8, 0, 1), 
            BorderColor = v3
        }, 
        ["Battleworn Green"] = {
    ...
    ["[SMG]"] = {
        ...
        Shadow = {
            TextureID = script.Meshes.Shadow.SMGGhost, 
            Rarity = "Exclusive", 
            CFrame = CFrame.new(-1.14440918E-5, 1.78813934E-7, -0.0263671875, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
            BorderColor = v3
        }, 
        ["Battleworn Green"] = {
    ...
    ["[Shotgun]"] = {
        ...
        Shadow = {
            TextureID = script.Meshes.Shadow.ShotgunGhost, 
            Rarity = "Exclusive", 
            CFrame = CFrame.new(3.05175781E-5, 0.199999928, 3.81469727E-6, -1, 0, -4.37113883E-8, 0, 1, 0, 4.37113883E-8, 0, -1), 
            BorderColor = v3
        }, 
        ["Battleworn Green"] = {
    ...
    ["[Rifle]"] = {
        ...
        Shadow = {
            TextureID = script.Meshes.Shadow.RifleGhost, 
            Rarity = "Exclusive", 
            CFrame = CFrame.new(2.44140625E-4, -0.100267321, -9.15527344E-5, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
            BorderColor = v3
        }, 
        ["Battleworn Green"] = {
    ...
    ["[TacticalShotgun]"] = {
        ...
        Shadow = {
            TextureID = script.Meshes.Shadow.TacticalShotgunGhost, 
            Rarity = "Exclusive", 
        ...
        Void = {
            TextureID = script.Meshes.Void.tact, 
            Rarity = "Legendary", 
    ...
    ["[RPG]"] = {
        ...
        Shadow = {
            TextureID = script.Meshes.Shadow.RPGGhost, 
            Rarity = "Exclusive", 
            CFrame = CFrame.new(1.22070312E-4, 0.0625389814, 0.00672149658, 1, 0, -8.74227766E-8, 5.00610797E-21, 1, 5.72632016E-14, 8.74227766E-8, 5.72632016E-14, 1), 
            BorderColor = v3
        }, 
        ["Battleworn Green"] = {
    ...
    ["[P90]"] = {
        ...
        Shadow = {
            TextureID = script.Meshes.Shadow.P90Ghost, 
            Rarity = "Exclusive", 
            CFrame = CFrame.new(6.86645508E-5, 2.18153E-4, 3.05175781E-5, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
            BorderColor = v3
        }, 
        ["Battleworn Green"] = {
    ...
    ["[LMG]"] = {
        ...
        Shadow = {
            TextureID = script.Meshes.Shadow.LMGGhost, 
            Rarity = "Exclusive", 
    ...
    ["[Flamethrower]"] = {
        ...
        Shadow = {
            TextureID = script.Meshes.Shadow.FlamethrowerGhost, 
            Rarity = "Exclusive", 
            CFrame = CFrame.new(-0.219947815, 0.339559376, 2.74658203E-4, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
            BorderColor = v3
        }, 
        ["Battleworn Green"] = {
    ...
    ["[Double-Barrel SG]"] = {
        ...
        Shadow = {
            TextureID = script.Meshes.Shadow.DoubleBGhost, 
            Rarity = "Exclusive", 
        ...
        ["Golden Age"] = {
            TextureID = script.Meshes.GoldenAge["Double Barrel"], 
            Rarity = "Legendary", 
        ...
        Dragon = {
            TextureID = script.Meshes.Dragon.DBDragon, 
            Rarity = "Legendary", 
            CFrame = CFrame.new(-0.123794556, 0.0481165648, 4.8828125E-4, 7.14693442E-7, 3.13283705E-10, 1, -4.56658222E-9, 1, -3.13281678E-10, -1, -4.56658533E-9, 7.14693442E-7), 
            Crate = 999
        }, 
        Heaven = {
            TextureID = script.Meshes.Heaven.DB, 
            Rarity = "Legendary", 
    ...
    ["[Glock]"] = {
        ...
        Shadow = {
            TextureID = script.Meshes.Shadow.GlockGhost, 
            Rarity = "Exclusive", 
    ...
    ["[AUG]"] = {
        ...
        Shadow = {
            TextureID = script.Meshes.Shadow.AUGGhost, 
            Rarity = "Exclusive", 
    ...
    ["[AR]"] = {
        ...
        Shadow = {
            TextureID = script.Meshes.Shadow.ARGhost, 
            Rarity = "Exclusive", 
            CFrame = CFrame.new(0.116256714, 0.0750004649, 6.10351562E-5, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
            BorderColor = v3
        }, 
        Halloween = {
    ...
    ["[AK47]"] = {
        ...
        Shadow = {
            TextureID = script.Meshes.Shadow.AK47Ghost, 
            Rarity = "Exclusive", 
            CFrame = CFrame.new(-0.750015259, 4.76837158E-7, -3.05175781E-5, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
            BorderColor = v3
        }, 
        ["Battleworn Green"] = {
    ...
    ["[Knife]"] = {
        ...
        Shadow = {
            CFrame = CFrame.new(1.1250186, 3.05175781E-5, 3.96728516E-4, 0, 1, 0, 1, 0, -4.37113883E-8, -4.37113883E-8, 0, -1), 
            Rarity = "Exclusive", 
            BorderColor = v3
        }, 
        Katar = {
        ...
        ["Screw Driver"] = {
            CFrame = CFrame.new(0.109568655, -0.0280584544, 6.21795654E-4, 0, 1, 0, 0, 0, -0.99999994, -1, 0, 0), 
            Rarity = "Common", 
            Crate = 2
        }, 
        Kitchen = {
        ...
        Emerald = {
            CFrame = CFrame.new(0.154518723, 0.116676092, 3.04222107E-4, 0, 1, 0, -1, 0, 0, 0, 0, 1), 
            Rarity = "Legendary", 
            Crate = 999
        }, 
        Golden = {
...
v32["[Flamethrower]"].Rainbow = {
    TextureID = "rbxassetid://12899496204", 
    Rarity = "Rare", 
    Crate = 1, 
    BorderColor = v9
};
v32["[Double-Barrel SG]"].Rainbow = {
...
v32["[Revolver]"].Electric = {
    TextureID = script.Meshes.Electric.ElectricRevolver, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.185462952, 0.0312761068, 6.10351562E-4, 0, 0, -1, 0, 1, 0, 1, 0, 0), 
    BorderColor = v12
};
v32["[DrumGun]"].Electric = {
    TextureID = script.Meshes.Electric.ElectricDrum, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.471969604, 0.184426308, 0.075378418, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
    BorderColor = v12
};
v32["[SMG]"].Electric = {
    TextureID = script.Meshes.Electric.ElectricSMG, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.0620956421, 0.109580457, 0.00729370117, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
    BorderColor = v12
};
v32["[Shotgun]"].Electric = {
    TextureID = script.Meshes.Electric.ElectricShotgun, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(6.10351562E-5, 0.180232108, -0.624732971, 1, 0, -4.37113883E-8, 0, 1, 0, 4.37113883E-8, 0, 1), 
    BorderColor = v12
};
v32["[Rifle]"].Electric = {
    TextureID = script.Meshes.Electric.ElectricRifle, 
    Rarity = "Exclusive", 
...
v32["[TacticalShotgun]"].Electric = {
    TextureID = script.Meshes.Electric.ElectricTac, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.0838031769, -0.0377542973, 0.00717163086, 0, 0, -1, 0, 1, 0, 1, 0, 0), 
    BorderColor = v12
};
v32["[RPG]"].Electric = {
    TextureID = script.Meshes.Electric.ElectricRPG, 
    Rarity = "Exclusive", 
...
v32["[AK47]"].Electric = {
    TextureID = script.Meshes.Electric.ElectricAK, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.155792236, 0.18423444, 0.00140380859, 0, 0, -1, 0, 1, 0, 1, 0, 0), 
    BorderColor = v12
};
v32["[Revolver]"]["8-BIT"] = {
    TextureID = script.Meshes.BIT8.RPixel, 
    Rarity = "Exclusive", 
...
v32["[Flamethrower]"]["8-BIT"] = {
    TextureID = script.Meshes.BIT8.FTPixel, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.0906066895, -0.0161985159, -0.0117645264, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
    BorderColor = v16
};
v32["[Double-Barrel SG]"]["8-BIT"] = {
    TextureID = script.Meshes.BIT8.DBPixel, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.240386963, -0.127295256, -0.00776672363, 0, 0, -1, 0, 1, 0, 1, 0, 0), 
    BorderColor = v16
};
v32["[RPG]"]["8-BIT"] = {
    TextureID = script.Meshes.BIT8.RPGPixel, 
    Rarity = "Exclusive", 
...
v32["[Revolver]"]["Red Skull"] = {
    TextureID = script.Meshes.RedSkull.RedSkullRev, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.0043258667, 0.0084195137, -0.00238037109, 0, 0, -1, 0, 1, 0, 1, 0, 0), 
    BorderColor = v17
};
v32["[Shotgun]"]["Red Skull"] = {
    TextureID = script.Meshes.RedSkull.RedSkullShotgun, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.00326538086, 0.0239292979, -0.039352417, -4.37113883E-8, 0, -1, 0, 1, 0, 1, 0, -4.37113883E-8), 
    BorderColor = v17
};
v32["[Double-Barrel SG]"]["Red Skull"] = {
    TextureID = script.Meshes.RedSkull.RedSkullDB, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.0143432617, -0.151709318, 0.00820922852, -1, 0, 0, 0, 1, 0, 0, 0, -1), 
    BorderColor = v17
};
v32["[RPG]"]["Red Skull"] = {
    TextureID = script.Meshes.RedSkull.RedSkullRPG, 
    Rarity = "Exclusive", 
...
v32["[Revolver]"].Kitty = {
    TextureID = script.Meshes.Kitty.KittyRevolver, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.0310440063, 0.0737591386, 0.0226745605, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
    BorderColor = v18
};
v32["[Flamethrower]"].Kitty = {
    TextureID = script.Meshes.Kitty.KittyFT, 
    Rarity = "Exclusive", 
...
v32["[RPG]"].Kitty = {
    TextureID = script.Meshes.Kitty.KittyRPG, 
    Rarity = "Exclusive", 
...
v32["[Shotgun]"].Kitty = {
    TextureID = script.Meshes.Kitty.KittyShotgun, 
    Rarity = "Exclusive", 
...
v32["[RPG]"].Toy = {
    ...
    BorderColor = v19, 
    LauncherCFrame = CFrame.new(-2.0980835E-4, 1.25527382E-4, -0.837677002, 1, 2.5768439E-12, -4.37113883E-8, 2.57684412E-12, 1, 6.29895225E-12, 4.37113883E-8, 6.29895225E-12, 1), 
    LauncherMesh = script.Meshes.Toy.RPG_LAUNCHER
};
v32["[Revolver]"].Galactic = {
    TextureID = script.Meshes.Galactic.galacticRev, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.049041748, 0.0399398208, -0.00772094727, 0, 0, 1, 0, 1, 0, -1, 0, 0), 
    BorderColor = v20
};
v32["[TacticalShotgun]"].Galactic = {
    TextureID = script.Meshes.Galactic.TacticalGalactic, 
    Rarity = "Exclusive", 
...
v32["[Revolver]"]["Web-Hero"] = {
    TextureID = script.Meshes.HERO.HeroWeb, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.0891418457, -0.0215809345, -0.0041809082, -1.99520325E-23, -1.62920685E-7, 1, 2.44929371E-16, 1, 1.62920685E-7, -1, 2.44929371E-16, 1.99520294E-23), 
    BorderColor = v21
};
v32["[Shotgun]"]["Bat-Hero"] = {
    TextureID = script.Meshes.HERO.HeroBat, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.00122070312, 0.141189337, 0.146026611, -1, 0, 0, 0, 1, 0, 0, 0, -1), 
    BorderColor = v21
};
v32["[Double-Barrel SG]"]["Angry-Hero"] = {
    TextureID = script.Meshes.HERO.HeroAngry, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.171646118, -0.0197404027, -0.00314331055, 0, 0, -1, 0, 1, 0, 1, 0, 0), 
    BorderColor = v21
};
v32["[RPG]"]["Robot-Hero"] = {
    TextureID = script.Meshes.HERO.HeroRobot, 
    Rarity = "Exclusive", 
...
v32["[RPG]"]["GPO-Ice"] = {
    ...
    LauncherMesh = script.Meshes.GPO.IceBoom
};
v32["[TacticalShotgun]"]["GPO-Magma"] = {
    TextureID = script.Meshes.GPO.MaguTact, 
    Rarity = "Exclusive", 
...
v32["[Rifle]"]["GPO-Light"] = {
    TextureID = script.Meshes.GPO.Rifle, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.208007812, 0.185256913, 6.10351562E-4, -3.37081539E-14, 1.62803403E-7, -1.00000012, -8.74227695E-8, 0.999999881, 1.63036205E-7, 1, 8.74227766E-8, -1.94552524E-14), 
    BorderColor = v22
};
v32["[Knife]"]["GPO-Knife"] = {
    Rarity = "Exclusive", 
...
v32["[Knife]"]["GPO-Knife Prestige"] = {
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.693048477, -0.0903320312, -0.00289916992, -1, 2.44929371E-16, 1.99520294E-23, 2.44929371E-16, 1, 1.62920685E-7, 1.99520325E-23, 1.62920685E-7, -1), 
    BorderColor = v11
};
v32["[Revolver]"].Devil = {
    TextureID = script.Meshes.CyanPack.Devil, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.0185699463, 0.293397784, -0.00256347656, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
    BorderColor = v24
};
v32["[TacticalShotgun]"].Cloud = {
    TextureID = script.Meshes.CyanPack.Cloud, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.0441589355, -0.0269355774, -7.01904297E-4, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
    BorderColor = v24
};
v32["[Double-Barrel SG]"].Flower = {
    TextureID = script.Meshes.CyanPack.DB, 
    Rarity = "Exclusive", 
...
v32["[RPG]"].Cookie = {
    TextureID = script.Meshes.CyanPack.rpg, 
    Rarity = "Exclusive", 
    ...
    BorderColor = v24, 
    LauncherCFrame = CFrame.new(1.83105469E-4, 2.18987465E-4, -0.0145568848, 4.37113883E-8, -1.62920671E-7, 1, -5.70182736E-14, 1, 1.62920671E-7, -1, 5.03866426E-14, 4.37113883E-8), 
    LauncherMesh = script.Meshes.CyanPack.Rocket
};
v32["[Knife]"].Frog = {
    Rarity = "Exclusive", 
...
v32["[Revolver]"].Cartoon = {
    TextureID = script.Meshes.Cartoon.CartoonRev, 
    Rarity = "Exclusive", 
...
v32["[Double-Barrel SG]"].Cartoon = {
    TextureID = script.Meshes.Cartoon.DBCartoon, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.00927734375, -0.00691050291, 7.32421875E-4, -1, -2.79396772E-8, -9.31322797E-10, -2.79396772E-8, 1, 1.42607872E-8, 9.31322575E-10, 1.42607872E-8, -1), 
    BorderColor = v25
};
v32["[RPG]"].Cartoon = {
    TextureID = script.Meshes.Cartoon.RPGCartoon, 
    Rarity = "Exclusive", 
    ...
    LauncherMesh = script.Meshes.Cartoon.RPGCartoonLauncher
};
v32["[Flamethrower]"].Cartoon = {
    TextureID = script.Meshes.Cartoon.CartoonFT, 
    Rarity = "Exclusive", 
...
v32["[Revolver]"].Stars = {
    DisplayName = "Thunder", 
    TextureID = script.Meshes.Stars.Revolver, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.0765533447, 0.0790345669, 0.00277709961, 1.99520325E-23, 1.62920685E-7, -1, 2.44929371E-16, 1, 1.62920685E-7, 1, -2.44929371E-16, -1.99520294E-23), 
    BorderColor = v26
};
v32["[Double-Barrel SG]"].Stars = {
    DisplayName = "Dino", 
    TextureID = script.Meshes.Stars.DB, 
    Rarity = "Exclusive", 
...
v32["[RPG]"].Stars = {
    DisplayName = "Speed", 
    TextureID = script.Meshes.Stars.RPG, 
    Rarity = "Exclusive", 
    ...
    LauncherMesh = script.Meshes.Stars.Rocket
};
v32["[Flamethrower]"].Stars = {
    DisplayName = "Starry", 
    TextureID = script.Meshes.Stars.Flamethrower, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-6.10351562E-5, 0.229534328, 0.0126647949, 0, 0, 1, 0, 1, 0, -1, 0, 0), 
    BorderColor = v26
};
v32["[Revolver]"]["DH-Verified"] = {
    TextureID = script.Meshes.Popular.VERIFIEDREV, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.049407959, -0.0454721451, 0.00158691406, -1, 0, 0, 0, 1, 2.22044605E-15, 0, -2.22044605E-15, -1), 
    NoTrade = true
};
v32["[Revolver]"]["DH-Stars II"] = {
    TextureID = script.Meshes.Popular.STARSREV, 
    Rarity = "Exclusive", 
...
v32["[Revolver]"].Arcade = {
    TextureID = script.Meshes.Arcade.Rev, 
    Rarity = "Legendary", 
    CFrame = CFrame.new(0.0578613281, -0.0479719043, -0.00115966797, -1.00000405, 1.15596135E-16, 1.64267286E-30, -1.15596135E-16, 1, 2.99751983E-14, 1.66683049E-30, -2.99751983E-14, -1.00000405), 
    NoTrade = false, 
    Crate = 999
};
v32["[Double-Barrel SG]"].Arcade = {
    TextureID = script.Meshes.Arcade.DB, 
    Rarity = "Legendary", 
    CFrame = CFrame.new(0.0578613281, -0.0479719043, -0.00115966797, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
    NoTrade = false, 
    Crate = 999
};
v32["[Revolver]"].Spectre = {
    TextureID = script.Meshes.Spectre.Rev, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.0578613281, -0.0479719043, -0.00115966797, -1.00000405, 1.15596135E-16, 1.64267286E-30, -1.15596135E-16, 1, 2.99751983E-14, 1.66683049E-30, -2.99751983E-14, -1.00000405)
};
v32["[Revolver]"].CandyCane = {
    DisplayName = "GPO-Rev", 
    TextureID = script.Meshes.CandyCane.Rev, 
    Rarity = "Exclusive", 
...
v32["[Revolver]"].PrestigeCandyCane = {
    DisplayName = "GPO-Rev Prestige", 
    TextureID = script.Meshes.CandyCane.PrestigeRev, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.3, -0.0479719043, -0.00115966797, -1.00000405, 1.15596135E-16, 1.64267286E-30, -1.15596135E-16, 1, 2.99751983E-14, 1.66683049E-30, -2.99751983E-14, -1.00000405), 
    BorderColor = v11
};
v32["[Knife]"].CyanKarambit = {
    DisplayName = "Cyan", 
    Rarity = "Exclusive", 
...
v32["[Revolver]"].Mystical = {
    TextureID = script.Meshes.Mystical.Revolver, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.015838623, -0.0802496076, 0.00772094727, 1, 0, 4.37113883E-8, 0, 1, 0, -4.37113883E-8, 0, 1), 
    BorderColor = v27
};
v32["[Double-Barrel SG]"].Mystical = {
    TextureID = script.Meshes.Mystical.DB, 
    Rarity = "Exclusive", 
...
v32["[RPG]"].Mystical = {
    TextureID = script.Meshes.Mystical.RPG, 
    Rarity = "Exclusive", 
    ...
    LauncherMesh = script.Meshes.Mystical.Launcher
};
v32["[Flamethrower]"].Mystical = {
    TextureID = script.Meshes.Mystical.Flamethrower, 
    Rarity = "Exclusive", 
...
v32["[RPG]"].Candy = {
    ...
    LauncherMesh = script.Meshes.Candy.RPGLAUNCHER
};
v32["[RPG]"].Cake = {
    TextureID = script.Meshes.Barbie.rpg, 
    Rarity = "Exclusive", 
    ...
    LauncherMesh = script.Meshes.Barbie.rpglaunhcher
};
v32["[Double-Barrel SG]"].Car = {
    TextureID = script.Meshes.Barbie.db, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.0457763672, 0.0508109927, 5.79833984E-4, -1, 0, 0, 0, 1, 0, 0, 0, -1), 
    BorderColor = v0
};
v32["[Revolver]"].Skeleton = {
    TextureID = script.Meshes.Barbie.Revol, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.0218505859, -0.0277693868, 0.0029296875, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
    BorderColor = v0
};
v32["[Flamethrower]"].Doll = {
    TextureID = script.Meshes.Barbie.FT, 
    Rarity = "Exclusive", 
...
v32["[RPG]"].Soul = {
    TextureID = script.Meshes.Soul.RPG, 
    Rarity = "Exclusive", 
    ...
    LauncherMesh = script.Meshes.Soul.launcher
};
v32["[Double-Barrel SG]"].Soul = {
    TextureID = script.Meshes.Soul.db, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.405822754, 0.0975035429, -0.00506591797, -1, 0, 0, 0, 1, 0, 0, 0, -1), 
    BorderColor = v28
};
v32["[Revolver]"].Soul = {
    TextureID = script.Meshes.Soul.rev, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.0646362305, 0.2725088, -0.00242614746, 0, 0, -1, 0, 1, 0, 1, 0, 0), 
    BorderColor = v28
};
v32["[TacticalShotgun]"].Soul = {
    TextureID = script.Meshes.Soul.tact, 
    Rarity = "Exclusive", 
...
v32["[Silencer]"].Mummy = {
    TextureID = script.Meshes.Raygun.mummy, 
    Rarity = "Exclusive", 
...
v32["[Revolver]"].Halloween23 = {
    TextureID = script.Meshes.Halloween.Rev, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.0257873535, -0.0117108226, -0.00671386719, -1, 0, 0, 0, 1, 0, 0, 0, -1), 
    BorderColor = v28
};
v32["[Knife]"].Halloween23 = {
    Rarity = "Exclusive", 
...
v32["[Double-Barrel SG]"].Halloween23 = {
    TextureID = script.Meshes.Halloween.DB, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.00271606445, -0.0485508144, 7.32421875E-4, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
    BorderColor = v28
};
v32["[TacticalShotgun]"].Halloween23 = {
    TextureID = script.Meshes.Halloween.Tact, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.0715637207, -0.0843618512, 0.00582885742, -1, 0, 0, 0, 1, 0, 0, 0, -1), 
    BorderColor = v28
};
v32["[Shotgun]"].Halloween23 = {
    TextureID = script.Meshes.Halloween.SG, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.00573730469, 0.294590235, -0.115814209, 0, 0, -1, 0, 1, 0, 1, 0, 0), 
    BorderColor = v28
};
v32["[RPG]"].Halloween23 = {
    TextureID = script.Meshes.Halloween.RPG, 
    Rarity = "Exclusive", 
    ...
    LauncherMesh = script.Meshes.Halloween.Launcher
};
v32["[TacticalShotgun]"].Numbers = {
    TextureID = script.Meshes.Numbers.Tactical, 
    Rarity = "Legendary", 
    CFrame = CFrame.new(-0.347015381, -0.101575613, -0.0437011719, 0, 0, 1, 0, 1, 0, -1, 0, 0), 
    BorderColor = v28, 
    Crate = 999
};
v32["[Double-Barrel SG]"].Magma = {
    TextureID = script.Meshes.Numbers.MagmaDB, 
    Rarity = "Legendary", 
    CFrame = CFrame.new(-0.750671387, 0.339070976, 0.0111999512, 0, 0, 1, 0, 1, 0, -1, 0, 0), 
    BorderColor = v28, 
    Crate = 999
};
v32["[TacticalShotgun]"].Undead = {
    TextureID = script.Meshes.Undead.Tact, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.558105469, -0.00996416807, 0.0152893066, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
    BorderColor = v28
};
v32["[RPG]"].Undead = {
    TextureID = script.Meshes.Undead.RPG, 
    Rarity = "Exclusive", 
    ...
    LauncherMesh = script.Meshes.Undead.Rocket
};
v32["[Revolver]"].Undead = {
    TextureID = script.Meshes.Undead.rev, 
    Rarity = "Exclusive", 
...
v32["[Double-Barrel SG]"].Undead = {
    TextureID = script.Meshes.Undead.AstroDB, 
    Rarity = "Exclusive", 
...
v32["[RPG]"].Spooky = {
    ...
    LauncherMesh = script.Meshes.Spooky.Launcher
};
v32["[Flamethrower]"].Spooky = {
    DisplayName = "Eye", 
    TextureID = script.Meshes.Spooky.FT, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.415008545, 0.349902928, -0.00164794922, 0, 0, -1, 0, 1, 0, 1, 0, 0), 
    BorderColor = v28
};
v32["[Double-Barrel SG]"].Spooky = {
    DisplayName = "Eye", 
    TextureID = script.Meshes.Spooky.DB, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.170593262, 0.0795405507, -6.10351562E-5, 1, 0, 0, 0, 0.999999762, 0, 0, 0, 0.999999762), 
    BorderColor = v28
};
v32["[Knife]"].Spooky = {
    DisplayName = "Magma", 
...
v32["[RPG]"].Etheral = {
    ...
    LauncherMesh = script.Meshes.Etheral.Launcher
};
v32["[Knife]"].Etheral = {
    Rarity = "Exclusive", 
...
v32["[Revolver]"].Ice = {
    DisplayName = "Frozen", 
    TextureID = script.Meshes.Ice.rev, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.0299072266, 0.0293902755, -0.0108032227, 1, 0, 0, 0, 0, 1, 0, -1, 0), 
    BorderColor = v31
};
v32["[TacticalShotgun]"].Ice = {
    DisplayName = "Frozen", 
    TextureID = script.Meshes.Ice.tact, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.151062012, 0.0138154626, 3.66210938E-4, 1, 0, 0, 0, 0, 1, 0, -1, 0), 
    BorderColor = v31
};
v32["[Knife]"]["Ice Sword"] = {
...
v32["[Double-Barrel SG]"].Ice = {
    DisplayName = "Frozen", 
    TextureID = script.Meshes.Ice.DB, 
    Rarity = "Exclusive", 
...
v32["[RPG]"].Ice = {
    DisplayName = "Frozen", 
    TextureID = script.Meshes.Ice.RPG, 
    Rarity = "Exclusive", 
    ...
    LauncherMesh = script.Meshes.Ice.Launcher
};
v32["[Revolver]"].Hoodmas = {
    TextureID = script.Meshes.Hoodmas.revolver, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.00862121582, -7.40110874E-4, -9.765625E-4, 1, 0, 0, 0, 1, 0, 0, 0, 1)
};
v32["[Double-Barrel SG]"].Hoodmas = {
    TextureID = script.Meshes.Hoodmas.db, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0, 0, 0) * CFrame.Angles(0, 3.141592653589793, 0)
};
v32["[Shotgun]"].Hoodmas = {
    TextureID = script.Meshes.Hoodmas.shotgun, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0, 0, 0) * CFrame.Angles(0, -1.5707963267948966, 0)
};
v32["[AR]"].Hoodmas = {
    TextureID = script.Meshes.Hoodmas.ar, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0, 0, 0) * CFrame.Angles(0, 3.141592653589793, 0)
};
v32["[TacticalShotgun]"].Hoodmas = {
    TextureID = script.Meshes.Hoodmas.tact, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0, 0, 0)
};
v32["[Flamethrower]"].Hoodmas = {
    TextureID = script.Meshes.Hoodmas.flamethrower, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0, 0, 0) * CFrame.Angles(0, 3.141592653589793, 0)
};
v32["[RPG]"].Hoodmas = {
    TextureID = script.Meshes.Hoodmas.rpg, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0, 0, 0) * CFrame.Angles(0, -1.5707963267948966, 0)
};
v32["[Knife]"].Hoodmas = {
...
v32["[Revolver]"].XMAS = {
    TextureID = script.Meshes.XMAS.Rev, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.0034942627, -0.0323467255, -2.44140625E-4, -1.00000095, 7.45058149E-9, 0, -7.45058149E-9, 0.999999523, 0, 0, 0, -1)
};
v32["[Knife]"].XMAS = {
    Rarity = "Exclusive", 
...
v32["[Flamethrower]"].XMAS = {
    TextureID = script.Meshes.XMAS.Flamethrower, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.528900146, 0.0900247097, 6.5612793E-4, 1, 0, 0, 0, 1, 0, 0, 0, 1)
};
v32["[RPG]"].XMAS = {
    TextureID = script.Meshes.XMAS.rpg, 
    Rarity = "Exclusive", 
    ...
    LauncherMesh = script.Meshes.XMAS.Ornament
};
v32["[Double-Barrel SG]"].XMAS = {
    TextureID = script.Meshes.XMAS.DB, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(1.39941406, 0.0596529841, -0.0409545898, 1, 0, 0, 0, 1, 0, 0, 0, 1)
};
v32["[Knife]"]["Crystal Karambit"] = {
...
v32["[Revolver]"].Portal = {
    TextureID = script.Meshes.Portal.rev, 
    Rarity = "Exclusive", 
    BorderColor = v1, 
    CFrame = CFrame.new(0.072303772, 0.0471935868, -0.0138244629, -1, 0, 0, 0, 0.99999994, 0, 0, 0, -1)
};
v32["[TacticalShotgun]"].Portal = {
    TextureID = script.Meshes.Portal.Tact, 
    Rarity = "Exclusive", 
    BorderColor = v1, 
    CFrame = CFrame.new(-1.0434494, 0.0293064713, -0.063079834, -1, 0, 0, 0, 1, 0, 0, 0, -1)
};
v32["[Double-Barrel SG]"].Portal = {
    TextureID = script.Meshes.Portal.DB, 
    Rarity = "Exclusive", 
    BorderColor = v1, 
...
v32["[RPG]"].Portal = {
    TextureID = script.Meshes.Portal.rpg, 
    Rarity = "Exclusive", 
    BorderColor = v1, 
...
v32["[RPG]"].Love = {
    ...
    LauncherMesh = script.Meshes.Love.Launcher
};
v32["[Flamethrower]"].Love = {
    TextureID = script.Meshes.Love.FT, 
    Rarity = "Exclusive", 
...
v32["[Revolver]"].Cupid = {
    TextureID = script.Meshes.Cupid.rev, 
    Rarity = "Exclusive", 
    BorderColor = v0, 
    CFrame = CFrame.new(0.0240020752, 0.229963183, -0.0170898438, 0, 0, -1, 0, 1, 0, 1, 0, 0)
};
v32["[Double-Barrel SG]"].Cupid = {
    TextureID = script.Meshes.Cupid.db, 
    Rarity = "Exclusive", 
    BorderColor = v0, 
...
v32["[RPG]"].Cupid = {
    TextureID = script.Meshes.Cupid.rpg, 
    Rarity = "Exclusive", 
    BorderColor = v0, 
    ...
    LauncherMesh = script.Meshes.Cupid.Launcher
};
v32["[Revolver]"].Shader = {
    TextureID = script.Meshes.Shader.Rev, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.00216674805, 0.0199100971, -0.00390625, -1, 0, 0, 0, 1, 0, 0, 0, -1), 
    DisplayName = "Squid", 
    BorderColor = v16
};
v32["[Double-Barrel SG]"].Shader = {
    TextureID = script.Meshes.Shader.DB, 
    Rarity = "Exclusive", 
...
v32["[RPG]"].Shader = {
    TextureID = script.Meshes.Shader.RPG, 
    Rarity = "Exclusive", 
    ...
    LauncherMesh = script.Meshes.Shader.Bear, 
    DisplayName = "Arcade", 
    BorderColor = v16
};
v32["[Knife]"].Shader = {
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.338645697, 1.83105469E-4, 0.0258331299, -1, 0, 0, 0, -1, 0, 0, 0, 1), 
    DisplayName = "Chain", 
    BorderColor = v16
};
v32["[Flamethrower]"].Shader = {
    TextureID = script.Meshes.Shader.FT, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.144821167, 0.0677314401, -0.00170898438, 0, 0, 1, 0, 1, 0, -1, 0, 0), 
    DisplayName = "Boba", 
    BorderColor = v16
};
v32["[Knife]"]["Dual Bayonets"] = {
    CFrame = CFrame.new(-0.520424962, 0.0484008789, -0.00109863281, 0, 1, 0, 1, 0, 0, 0, 0, -1), 
    Rarity = "Legendary", 
    Crate = 999
};
v32["[Knife]"]["RGB Dual Bayonets"] = {
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.520424962, 0.0484008789, -0.00109863281, 0, 1, 0, 1, 0, 0, 0, 0, -1), 
    BorderColor = v9
};
v32["[Revolver]"].Military = {
    TextureID = script.Meshes.Military.Rev, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.0181350708, -0.10841608, -0.00543212891, 0, 0, 1, 1.49010297E-8, 1, 0, -1, 1.49010297E-8, 0), 
    BorderColor = v6
};
v32["[TacticalShotgun]"].Military = {
    TextureID = script.Meshes.Military.Tact, 
    Rarity = "Exclusive", 
...
v32["[RPG]"].Military = {
    ...
    LauncherCFrame = CFrame.new(7.93457031E-4, 0.00350522995, 0.530632019, -1, -2.71050543E-20, 4.37113883E-8, -3.3601404E-13, 1, -7.68710379E-6, -4.37113883E-8, -7.68710379E-6, -1), 
    LauncherMesh = script.Meshes.Military.Launcher
};
v32["[Double-Barrel SG]"].Military = {
    TextureID = script.Meshes.Military.db, 
    Rarity = "Exclusive", 
...
v32["[Knife]"].Military = {
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.0253430605, 0.106079102, 4.65393066E-4, 0, 3.25960725E-9, -1, 0, 1, 3.25960747E-9, 1, 0, -0), 
    BorderColor = v6
};
v32["[Vehicle]"]["Toy Tank"] = {
    Rarity = "Exclusive", 
    BorderColor = v6
};
v32["[Vehicle]"].Tractor = {
...
v32["[Revolver]"].Ruby = {
    TextureID = script.Meshes.Ruby.rev, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.0331878662, -0.0243580937, 5.18798828E-4, 0, 0, -1, 0, 1, 0, 1, 0, 0), 
    BorderColor = v2
};
v32["[Double-Barrel SG]"].Ruby = {
    TextureID = script.Meshes.Ruby.db, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.0772705078, -0.0124946237, -0.00723266602, 0, 0, 0.999999642, 0, 1, 0, -1, 0, 0), 
    BorderColor = v2
};
v32["[RPG]"].Ruby = {
    TextureID = script.Meshes.Ruby.RPG, 
    Rarity = "Exclusive", 
    ...
    LauncherCFrame = CFrame.new(0.00180053711, 7.30276108E-4, 0.176605225, 1, 5.82076609E-11, -4.37113883E-8, -5.78716935E-11, 1, 7.68612699E-6, 4.37113883E-8, -7.68612699E-6, 1), 
    LauncherMesh = script.Meshes.Ruby.Launcher, 
    BorderColor = v2
};
v32["[Flamethrower]"].Ruby = {
    TextureID = script.Meshes.Ruby.ft, 
    Rarity = "Exclusive", 
...
v32["[Vehicle]"].TriWheel = {
    Rarity = "Exclusive"
};
v32["[Vehicle]"]["TriWheel Red"] = {
    Rarity = "Legendary", 
    Crate = 999
};
v32["[House]"]["Modern Town"] = {
    Rarity = "Exclusive"
};
v32["[House]"]["Holiday Town"] = {
    Rarity = "Exclusive"
};
v32["[House]"]["Gingerbread House"] = {
    Rarity = "Exclusive"
};
v32["[Knife]"].Spatula = {
    Rarity = "Exclusive", 
...
v32["[House]"]["Pizza Restaurant"] = {
    Rarity = "Exclusive"
};
v32["[Vehicle]"]["Delivery Moped"] = {
    Rarity = "Exclusive"
};
v32["[Vehicle]"]["Delivery Car"] = {
    Rarity = "Exclusive"
};
v32["[Revolver]"].Gothic = {
    TextureID = script.Meshes.gothic.Rev, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.0787200928, 0.0141905546, -0.00573730469, -1, 0, 0, 0, 1, 0, 0, 0, -1), 
    BorderColor = v4
};
v32["[Double-Barrel SG]"].Gothic = {
    TextureID = script.Meshes.gothic.db, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.194915771, 0.174392939, -0.001953125, 0.999998927, 0, 0, 0, 1, 0, 0, 0, 1), 
    BorderColor = v4
};
v32["[Drum-Shotgun]"].Gothic = {
    TextureID = script.Meshes.gothic.Drum, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.0383834839, 0.183659613, 0.00665283203, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
    BorderColor = v4
};
v32["[RPG]"].Gothic = {
    TextureID = script.Meshes.gothic.rpg, 
    Rarity = "Exclusive", 
    ...
    LauncherCFrame = CFrame.new(6.10351562E-5, 0.00457000732, -0.492790222, 4.37113883E-8, 3.97903932E-13, 0.999999642, -2.40179304E-7, 1, 4.08402343E-13, -1, 2.40179304E-7, 4.37113741E-8), 
    LauncherMesh = script.Meshes.gothic.Launcher, 
    BorderColor = v4
};
v32["[Knife]"].Gothic = {
    Rarity = "Exclusive", 
...
v32["[House]"]["Garage Home"] = {
    Rarity = "Exclusive"
};
v32["[Vehicle]"]["Muscle B"] = {
    Rarity = "Exclusive"
};
v32["[Vehicle]"]["Muscle B [Black]"] = {
    Rarity = "Legendary", 
    Crate = 999
};
v32["[Vehicle]"]["Muscle C"] = {
    Rarity = "Exclusive"
};
v32["[Vehicle]"]["Muscle C [Black]"] = {
    Rarity = "Legendary", 
    Crate = 999
};
v32["[Vehicle]"]["Muscle C [Purple]"] = {
    Rarity = "Legendary", 
    Crate = 999
};
v32["[Vehicle]"]["SUV [Black]"] = {
...
v32["[Revolver]"].Penguin = {
    TextureID = script.Meshes.Penguin.rev, 
    Rarity = "Exclusive", 
...
v32["[Double-Barrel SG]"].Penguin = {
    TextureID = script.Meshes.Penguin.db, 
    Rarity = "Exclusive", 
...
v32["[RPG]"].Penguin = {
    TextureID = script.Meshes.Penguin.rpg, 
    Rarity = "Exclusive", 
    ...
    LauncherMesh = script.Meshes.Penguin.Launcher, 
    BorderColor = v7
};
v32["[Flamethrower]"].Penguin = {
    TextureID = script.Meshes.Penguin.FT, 
    Rarity = "Exclusive", 
...
v32["[Revolver]"].Metal = {
    TextureID = script.Meshes.Metal.rev, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.0964050293, -0.0217685103, -5.49316406E-4, 1, 0, -1.50995803E-7, 0, 0.999999642, 0, 1.50995803E-7, 0, 1)
};
v32["[Double-Barrel SG]"].Metal = {
    TextureID = script.Meshes.Metal.db, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.125686646, -0.135336846, 0.00628662109, 0, 0, -1, 0, 0.999998212, 0, 1, 0, 0)
};
v32["[Flamethrower]"].Metal = {
    TextureID = script.Meshes.Metal.ft, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.14163208, 0.573509276, 0.024230957, 0, 0, -1, 0, 0.999999046, 0, 1, 0, 0)
};
v32["[Rifle]"].Metal = {
    TextureID = script.Meshes.Metal.rifle, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.285713196, 0.0110580921, -7.93457031E-4, 2.01746307E-17, -2.32830588E-10, 1.00000024, -3.18550298E-17, 0.999999523, -2.32830644E-10, -1, 3.18550232E-17, -2.01746307E-17)
};
v32["[RPG]"].Metal = {
    TextureID = script.Meshes.Metal.rpg, 
    Rarity = "Exclusive", 
    ...
    LauncherCFrame = CFrame.new(-0.00189208984, -7.38143921E-4, -0.14730072, -1, 8.8817842E-16, 4.37113812E-8, -9.0868604E-16, 0.999999881, -4.69157047E-10, -4.37113883E-8, 4.69157102E-10, -0.999999821), 
    LauncherMesh = script.Meshes.Metal.launcher
};
v32["[Revolver]"]["Iced Out"] = {
    TextureID = script.Meshes.IcedOut.rev, 
    Rarity = "Legendary", 
    Crate = 1, 
    CFrame = CFrame.new(-0.0419578552, -0.0496253371, -9.765625E-4, 0, 0, -1, 0, 1, 0, 1, 0, 0)
};
v32["[Double-Barrel SG]"]["Iced Out"] = {
    TextureID = script.Meshes.IcedOut.db, 
    Rarity = "Legendary", 
    Crate = 1, 
...
v32["[RPG]"].Cat = {
    ...
    LauncherMesh = script.Meshes.Cat.Rocket
};
v32["[Drum-Shotgun]"].Cat = {
    TextureID = script.Meshes.Cat.drum, 
    Rarity = "Exclusive", 
    BorderColor = v5, 
...
v32["[Double-Barrel SG]"].Cat = {
    TextureID = script.Meshes.Cat.db, 
    Rarity = "Exclusive", 
    BorderColor = v5, 
    CFrame = CFrame.new(-0.321357727, -0.021577239, -3.66210938E-4, -1, 0, 0, 0, 1, -3.25059773E-30, 0, 3.25059773E-30, -1)
};
v32["[Revolver]"].Unicorn = {
    TextureID = script.Meshes.Unicorn.rev, 
    Rarity = "Exclusive", 
...
v32["[Double-Barrel SG]"].Unicorn = {
    TextureID = script.Meshes.Unicorn.db, 
    Rarity = "Exclusive", 
...
v32["[TacticalShotgun]"].Unicorn = {
    TextureID = script.Meshes.Unicorn.tact, 
    Rarity = "Exclusive", 
...
v32["[RPG]"].Unicorn = {
    TextureID = script.Meshes.Unicorn.rpg, 
    Rarity = "Exclusive", 
    ...
    LauncherMesh = script.Meshes.Unicorn.launcher, 
    BorderColor = v18
};
v32["[Vehicle]"].Unicorn = {
    Rarity = "Exclusive", 
...
v32["[Revolver]"].Reptile = {
    TextureID = script.Meshes.Reptile.rev, 
    Rarity = "Legendary", 
    Crate = 1, 
    CFrame = CFrame.new(0.0178756714, 0.0200323462, -0.00146484375, 1, 0, 0, 0, 0.999995708, 0, 0, 0, 0.999995708)
};
v32["[Double-Barrel SG]"].Reptile = {
    TextureID = script.Meshes.Reptile.db, 
    Rarity = "Legendary", 
    Crate = 1, 
...
v32["[RPG]"].Aqua = {
    TextureID = script.Meshes.Aqua.rpg, 
    Rarity = "Exclusive", 
    ...
    LauncherMesh = script.Meshes.Aqua.Rocket, 
    BorderColor = v12
};
v32["[Revolver]"].Aqua = {
    TextureID = script.Meshes.Aqua.rev, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.105384827, 0.208259106, 0.00799560547, 1, -5.87381323E-27, 0, -5.87381323E-27, 1, 0, 0, 0, 1), 
    BorderColor = v12
};
v32["[Double-Barrel SG]"].Aqua = {
    TextureID = script.Meshes.Aqua.db, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.204410553, 0.268578529, 0.0223999023, -1.00000572, 2.90278896E-27, 0, -2.90275526E-27, 0.999988556, 0, 0, 0, -0.999994278), 
    BorderColor = v12
};
...
v32["[Revolver]"].Wire = {
    TextureID = script.Meshes.Wire.rev, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.00971221924, 0.0132867098, 1.22070312E-4, 0, 0, -1, 0, 1, 0, 1, 0, 0), 
    BorderColor = v12
};
v32["[Double-Barrel SG]"].Wire = {
    TextureID = script.Meshes.Wire.db, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.12754631, -0.0147626996, -0.0191040039, 0, 0, 1, 0, 1, 0, -1, 0, 0), 
    BorderColor = v12
};
v32["[SMG]"].Wire = {
    TextureID = script.Meshes.Wire.smg, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.228622437, -0.115716159, -0.0379638672, 0, 0, 1, 0, 1, 0, -1, 0, 0), 
    BorderColor = v12
};
v32["[Flamethrower]"].Wire = {
    TextureID = script.Meshes.Wire.ft, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.484739304, 0.240048289, 0.0125732422, 0, 0, 1, 0, 1, 0, -1, 0, 0), 
    BorderColor = v12
};
v32["[RPG]"].Wire = {
    TextureID = script.Meshes.Wire.rpg, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-8.54492188E-4, 0.044478178, 0.30198288, -1, 2.27373621E-13, 4.37113883E-8, -2.27537661E-13, 1, -3.75266085E-9, -4.37113883E-8, 3.75266085E-9, -1), 
    LauncherCFrame = CFrame.new(-8.54492188E-4, -0.00822412968, 0.0817947388, -1, 2.27373621E-13, 4.37113883E-8, -2.27537661E-13, 1, -3.75277542E-9, -4.37113883E-8, 3.75277542E-9, -1), 
    LauncherMesh = script.Meshes.Wire.Rocket, 
    BorderColor = v12
};
v32["[Knife]"].SoulII = {
    DisplayName = "Ghost", 
...
v32["[RPG]"].SoulII = {
    DisplayName = "Ghost", 
    TextureID = script.Meshes.SoulII.rpg, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.0422363281, 0.243108392, -0.243370056, -4.37113883E-8, 1.79695434E-18, -1, -5.64731205E-13, 1, -1.7722692E-18, 1, -5.64731205E-13, -4.37113883E-8), 
    LauncherCFrame = CFrame.new(0.00384521484, 0.00943088531, -0.653934479, -1, 1.73472337E-18, 4.37113883E-8, -1.7772753E-18, 1, -9.73473906E-13, -4.37113883E-8, 9.73473906E-13, -1), 
    LauncherMesh = script.Meshes.SoulII.Rocket, 
    BorderColor = v29
};
v32["[Revolver]"].SoulII = {
    DisplayName = "Ghost", 
    TextureID = script.Meshes.SoulII.rev, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.105384827, 0.208259106, 0.00799560547, 1, -5.87381323E-27, 0, -5.87381323E-27, 1, 0, 0, 0, 1), 
    BorderColor = v29
};
v32["[Double-Barrel SG]"].SoulII = {
    DisplayName = "Ghost", 
    TextureID = script.Meshes.SoulII.db, 
    Rarity = "Exclusive", 
...
v32["[Revolver]"].Nightmare = {
    TextureID = script.Meshes.Nightmare.rev, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.200012207, -0.0815875828, 0.0110473633, 0, 0, 1, 0, 1, 0, -1, 0, 0), 
    BorderColor = v28
};
v32["[Double-Barrel SG]"].Nightmare = {
    TextureID = script.Meshes.Nightmare.db, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.36031723, 0.00864857435, -0.00158691406, -1, 0, 0, 0, 1, 0, 0, 0, -1), 
    BorderColor = v28
};
v32["[RPG]"].Nightmare = {
    TextureID = script.Meshes.Nightmare.rpg, 
    Rarity = "Exclusive", 
    ...
    LauncherMesh = script.Meshes.Nightmare.launcher, 
    BorderColor = v28
};
v32["[Flamethrower]"].Nightmare = {
    TextureID = script.Meshes.Nightmare.ft, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.395851135, 0.238022804, 0.079284668, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
    BorderColor = v28
};
v32["[Vehicle]"].Nightmare = {
    Rarity = "Exclusive", 
    BorderColor = v28
};
v32["[Revolver]"].Butterfly = {
    TextureID = script.Meshes.Butterfly.Rev, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.0578613281, -0.0479719043, -0.00115966797, -1.00000405, 1.15596135E-16, 1.64267286E-30, -1.15596135E-16, 1, 2.99751983E-14, 1.66683049E-30, -2.99751983E-14, -1.00000405), 
    BorderColor = v0
};
...
v32["[Double-Barrel SG]"].Butterfly = {
    TextureID = script.Meshes.Butterfly.DB, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.36031723, 0.00864857435, -0.00158691406, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
    BorderColor = v0
};
v32["[Revolver]"].Emerald = {
    TextureID = script.Meshes.Emerald.Rev, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.200012207, -0.0815875828, 0.0110473633, 0, 0, -1, 0, 1, 0, 1, 0, 0), 
    BorderColor = v15
};
v32["[Knife]"]["Emerald-Bayonet"] = {
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.248047352, -0.0400543213, -0.0659179688, 0, 1, 0, 0.999998093, 0, 0, 0, 0, -1), 
    BorderColor = v15
};
v32["[Double-Barrel SG]"].Emerald = {
    TextureID = script.Meshes.Emerald.DB, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.200012207, -0.0815875828, 0.0110473633, 0, 0, 1, 0, 1, 0, -1, 0, 0), 
    BorderColor = v15
};
v32["[AK47]"].Emerald = {
    TextureID = script.Meshes.Emerald.AK, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.200012207, -0.0815875828, 0.0110473633, 0, 0, 1, 0, 1, 0, -1, 0, 0), 
    BorderColor = v15
};
...
v32["[RPG]"].GPOII = {
    ...
    LauncherMesh = script.Meshes.GPOII.Rocket, 
    BorderColor = v22
};
v32["[Double-Barrel SG]"].GPOII = {
    TextureID = script.Meshes.GPOII.DB, 
    Rarity = "Exclusive", 
...
v32["[Revolver]"].XMAS24 = {
    DisplayName = "Hoodmas24", 
    TextureID = script.Meshes.XMAS24.Rev, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.15, -0.0815875828, 0.0110473633, -1, 0, 0, 0, 1, 0, 0, 0, -1), 
    BorderColor = v23
};
v32["[AK47]"].XMAS24 = {
    DisplayName = "Hoodmas24", 
    TextureID = script.Meshes.XMAS24.AK, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.200012207, -0.0815875828, 0.0110473633, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
    BorderColor = v23
};
v32["[RPG]"].XMAS24 = {
    DisplayName = "Hoodmas24", 
    TextureID = script.Meshes.XMAS24.RPG, 
    Rarity = "Exclusive", 
    ...
    LauncherMesh = script.Meshes.XMAS24.Rocket, 
    BorderColor = v23
};
v32["[Flamethrower]"].XMAS24 = {
    DisplayName = "Hoodmas24", 
    TextureID = script.Meshes.XMAS24.Flamethrower, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.200012207, -0.0815875828, 0.0110473633, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
    BorderColor = v23
};
v32["[Double-Barrel SG]"].XMAS24 = {
    DisplayName = "Hoodmas24", 
    TextureID = script.Meshes.XMAS24.DB, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.05, -0.0815875828, 0.0110473633, 1, 0, 0, 0, 1, 0, 0, 0, 1), 
    BorderColor = v23
};
v32["[Revolver]"].Grumpy = {
    TextureID = script.Meshes.Grumpy.rev, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(0.083902359, -7.52657652E-4, -0.00531005859, 0, 0, -1, 0, 1, 0, 1, 0, 0), 
    BorderColor = v15
};
v32["[LMG]"].Grumpy = {
    TextureID = script.Meshes.Grumpy.lmg, 
    Rarity = "Exclusive", 
    CFrame = CFrame.new(-0.0024433136, -0.184990644, -0.284179688, 4.37113883E-8, 0, -1, 0, 1, 0, 1, 0, 4.37113883E-8), 
    BorderColor = v15
};
v32["[Rifle]"].Grumpy = {
    TextureID = script.Meshes.Grumpy.rifle, 
    Rarity = "Exclusive", 
...
v32["[Double-Barrel SG]"].Grumpy = {
    TextureID = script.Meshes.Grumpy.db, 
    Rarity = "Exclusive", 
...
v32["[RPG]"].Grumpy = {
    TextureID = script.Meshes.Grumpy.rpg, 
    Rarity = "Exclusive", 
    ...
    LauncherMesh = script.Meshes.Grumpy.launcher, 
    BorderColor = v15
};
v32["[Revolver]"].Wrapped = {
    TextureID = script.Meshes.Wrapped.WrappedRev, 
    Rarity = "Exclusive", 
